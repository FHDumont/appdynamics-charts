...
```
$ helm repo add  appdynamics-charts https://fhdumont.github.io/appdynamics-charts
```
...
For detailed list of configuration settings refer to the [chart documentation](https://fhdumont.github.io/appdynamics-charts/machine-agent/)
...
For detailed list of configuration settings refer to the [chart documentation](https://fhdumont.github.io/appdynamics-charts/cluster-agent/)
